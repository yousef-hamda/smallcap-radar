   ...
   <div className="content">
    ...
    <div className={`overview-layout ${run?'has-run':''}`}>
     ...
     <section className="metric-row">
      ...
      <Metric icon={ShieldCheck} label="اجتازت" value={qualified} meta="فرصة" tone="positive"/>
