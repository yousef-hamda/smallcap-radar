...
- On 2026-09-26 the allocation map was rebuilt as a flat market heatmap: brighter solid green/red daily-move colors, no tile or text shadows, bounded zero overflow geometry, responsive density rules, and daily move plus weight shown in the tile and full ordered legend.
