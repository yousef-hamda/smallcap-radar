...
- The allocation visual was rebuilt on 2026-09-26 with flat brighter market-map tiles, no shadows or gradients in the heatmap, explicit frame clipping, daily move labels, and a complete market-value ordered legend for desktop and mobile.
