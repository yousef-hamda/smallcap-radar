...
- Coverage QA: 6,320/7,675 quote coverage; 13/13 official Frames datasets available through the dated fallback; 2,381/2,910 candidate fundamental coverage. Yahoo 52-week percentage-point normalization is protected by a regression test.
