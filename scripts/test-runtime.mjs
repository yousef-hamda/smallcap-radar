...
for(const [name,path] of [['scan-progress','lib/scan-progress.ts'],['visitor','lib/visitor.ts'],['http','lib/http.ts'],['client-json','lib/client-json.ts'],['validation','lib/validation.ts'],['portfolio','lib/portfolio.ts'],['portfolio-storage','lib/portfolio-storage.ts'],['storage','lib/storage.ts'],['scanner','lib/scanner.ts'],['reconcile','lib/reconcile.ts'],['push-validation','lib/push-validation.ts'],['worker','worker/index.ts'],['radar-api','app/api/radar/route.ts'],['portfolio-api','app/api/portfolio/route.ts'],['portfolio-history-api','app/api/portfolio-history/route.ts'],['portfolio-logo-api','app/api/portfolio-logo/route.ts'],['scan-report-api','app/api/scan-report/route.ts'],['chart-api','app/api/chart/route.ts']]) {
 ...
 if(['scanner','chart-api','portfolio-storage','portfolio-api','portfolio-history-api'].includes(name))js=js.replace("from './providers.mjs'","from '../tests/runtime/providers.mjs'");
 if(name==='worker'){
